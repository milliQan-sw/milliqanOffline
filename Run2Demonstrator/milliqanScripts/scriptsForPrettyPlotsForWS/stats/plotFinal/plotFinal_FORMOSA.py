...
for datasetName in ["directDetection","ArgoNeut","SK","MilliQ","FORMOSA_dem","milliQanRun3Both","milliQan","FORMOSA_nominal","SENSEI","CMS","Collider","FORMOSA_crystal100","SUBMET"][:-1]:
