...
# iterate over row and column combinations
    for row in range(4):
        for column in range(4):
            ...
            pulse_maskL0 = (self.events['row'] == row) & (self.events['column'] == column) & (self.events['layer'] == 0) & (self.events['height'] > 1000) & timeCut & (self.events['area'] > 55000)
            pulse_maskL1 = (self.events['row'] == row) & (self.events['column'] == column) & (self.events['layer'] == 1) & (self.events['height'] > 1000) & timeCut & (self.events['area'] > 55000)
            pulse_maskL2 = (self.events['row'] == row) & (self.events['column'] == column) & (self.events['layer'] == 2) & (self.events['height'] > 1000) & timeCut & (self.events['area'] > 55000)
            pulse_maskL3 = (self.events['row'] == row) & (self.events['column'] == column) & (self.events['layer'] == 3) & (self.events['height'] > 1000) & timeCut & (self.events['area'] > 55000)
