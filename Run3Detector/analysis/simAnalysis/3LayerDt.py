...
def getTimeDiff(self):
    ...
    for i in range(len(timeL0_min)):
        ...
        if timeL0_min[i] is not None and timeL2_min[i] is not None and timeL3_min[i] is not None:
...
h_1d = r.TH1F("h_1d", "Time Differences between Layer 2 and 0", 100, -50, 50)
...
# create a new TFile
f = r.TFile("3LayerDt1ExL20.root", "recreate")
