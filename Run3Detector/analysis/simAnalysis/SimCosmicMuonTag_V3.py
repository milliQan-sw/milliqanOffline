...
def EmptyListFilter(self,cutName=None):
    ...
    #FIXME:3-13 I notice a weird issue. using the new SimBarCut() that checks the None_empty_event. No!
    #Where cause the issue?
    #self.events['None_empty_event'], junk =  ak.broadcast_arrays(self.events['None_empty_event'], self.events['layer'])
...
if __name__ == "__main__":
    ...
    #cutflow1 = [MuonCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,P_TBBigHitCut,P_TBBigHitCutCount]
    ...
    cutflow1A = [MuonEventCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,P_TBBigHitCut,P_TBBigHitCutCount]
   
    #cut flow 1. but the muon event cut are removed

    cutflow1B = [mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,P_TBBigHitCut,P_TBBigHitCutCount]


    #Cut flow 2. This one is for testing the cut efficiency of different tags. TB big hits - > 4 rows big hits
    cutflow2 = [MuonCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,fourRowBigHitsCut,fourRowBigHitsCutCount]

    #cut flow2. but the the muon cut change the muon event cut
    cutflow2A = [MuonEventCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,fourRowBigHitsCut,fourRowBigHitsCutCount]

    #cut flow 2. but the muon event cut are removed
    cutflow2B = [mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,TBBigHitCut,TBBigHitCutCount,fourRowBigHitsCut,fourRowBigHitsCutCount]

    #cut flow 3. This one is for testing the cut efficiency of different tags. B + panel big hits  - > TB + panel big hits 
    cutflow3 = [MuonCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,P_BBigHitCut,P_BBigHitCutCount,TBBigHitCut,P_TBBigHitCut,P_TBBigHitCutCount]

    #Cut flow 3. but the the muon cut change the muon event cut
    cutflow3A = [MuonEventCut,mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,P_BBigHitCut,P_BBigHitCutCount,TBBigHitCut,P_TBBigHitCut,P_TBBigHitCutCount]

    #cut flow 3. but the muon event cut are removed
    cutflow3B = [mycuts.EmptyListFilter,mycuts.countEvent,mycuts.SimBarCut,mycuts.SimPanelCut,mycuts.CosmuonTagIntialization,P_BBigHitCut,P_BBigHitCutCount,TBBigHitCut,P_TBBigHitCut,P_TBBigHitCutCount]
