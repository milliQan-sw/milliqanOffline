...
def getMuonNum(self):
    ...
    hit_muons = self.events['hit_particleName'][(abs(self.events['hit_particleName']) == 13) & (self.events['hit_exitPositionZ_cm'] != 0)]
...
branches = ['hit_hitTime_ns', 'hit_nPE', 'hit_layer', 'hit_particleName', 'layer', 'nPE', 'time', 'hit_exitPositionZ_cm']
