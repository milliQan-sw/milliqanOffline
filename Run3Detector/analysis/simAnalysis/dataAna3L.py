...
def get3LNum(self):
    ...
    for i in range(len(timeL0_min)):
        ...
        if (timeL0_min[i] is not None and timeL1_min[i] is not None and timeL2_min[i] is not None and backPanelBool[i] == True) or \
           (timeL0_min[i] is not None and timeL1_min[i] is not None and timeL3_min[i] is not None and backPanelBool[i] == True) or \
           (timeL0_min[i] is not None and timeL2_min[i] is not None and timeL3_min[i] is not None and backPanelBool[i] == True) or \
           (timeL1_min[i] is not None and timeL2_min[i] is not None and timeL3_min[i] is not None and backPanelBool[i] == True):
