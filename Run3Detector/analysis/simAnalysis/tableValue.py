...
setattr(milliqanCuts, 'createMuonMask', milliqanCuts.createMuonMask)
setattr(milliqanCuts, 'getTimeDiff', milliqanCuts.getTimeDiff)
...
cutflow = [mycuts.createMuonMask, mycuts.getTimeDiff, myplotter.dict['h_1d']]
