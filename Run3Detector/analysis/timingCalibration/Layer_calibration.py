...
#Set the File path
path = '/net/cms26/cms26r0/milliqan/testCorrectionsRun3Hadd/v32_testCorrectionsV3/'
...
Runs = []
for i in Run_nums:
	Run = path+f'MilliQan_Run{i}_default_v32_testCorrectionsV3.root'
...
for hist in histos:
	...
	mean1Err = gaussFit.GetParError(1)#	mean2Err = gaussFit.GetParError(4)
