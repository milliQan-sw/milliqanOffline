...
def fit_histogram(hist, beamOn_true_percentage, root_file):
    ...
    combined_gaus = r.TF1("combined_gaus", "gaus(0) + gaus(3)", -26, 12) # Fit range ##############################################################################################################################
    
    # Initial parameter estimates for the two Gaussian functions
    combined_gaus.SetParameters(8, -17.5, 4.165, 21, 0.5, 5.635)  # Max Mean Stddev (left/right) ##################################################################################################################
    ...
    gaus1 = r.TF1("gaus1", "gaus", -26, -9)  # Left Range ########################################################################################################################################################
    gaus2 = r.TF1("gaus2", "gaus", -11, 12)  # Right Range #########################################################################################################################################################
    for i in range(3):
