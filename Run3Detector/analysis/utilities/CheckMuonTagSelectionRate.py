...
ST_TP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'ST_TP')
DW_TP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'DW_TP')
CL_TP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'CL_TP')

ST_FP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'ST_FP')
DW_FP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'DW_FP')
CL_FP_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'CL_FP')

ST_TN_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'ST_TN')
DW_TN_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'DW_TN')
CL_TN_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'CL_TN')

ST_FN_count = mycuts.getCut(mycuts.countEvent,'placeholder',Countobject= 'ST_FN')
