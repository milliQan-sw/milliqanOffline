...
def EventCheck(RunNum=1190,filenum=4,eventNum=47):
    ...
    pulseBasedBranches = ["pickupFlag","layer","nPE","type","area","chan","row","duration","height"]
    branches = ["runNumber","event","fileNumber",'boardsMatched',"pickupFlag","layer","nPE","type","area","chan","row","duration","height"]
