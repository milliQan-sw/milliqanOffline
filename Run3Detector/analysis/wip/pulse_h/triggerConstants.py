...
straightPaths = [[[0, 1], [16, 17], [32, 33], [48, 49]], 
                ...
                [[10, 11], [26, 27], [22, 23], [58, 59]],
                [[14, 15], [30, 31], [46, 47], [62, 63]]]

#inputs to read in through uproot
uprootInputs = ["event", "fileNumber", "time", "nPE", "height", "area", "chan", "row", "column", "layer", "type", "event_time_fromTDC", "tTrigger", "duration","npulses","DAQEventNumber","pickupFlag","board"]

#input for event-based
uprootEventBasedInput = ["DAQEventNumber","pickupFlag"]
