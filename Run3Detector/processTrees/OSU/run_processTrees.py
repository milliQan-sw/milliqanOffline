...
def parse_args():
    ...
    parser.add_argument('-v', '--version', type=str, default=None, help='Set the version of offline trees')
...
if __name__=="__main__":
    ...
    if args.version == None:
        out = subprocess.check_output("git describe --tag --abbrev=0",shell=True)
        args.version = out.strip().decode()
