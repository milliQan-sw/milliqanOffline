...
int checkTriggers(){
    ...
    mychain->Add("/store/user/mcarrigan/trees/MilliQan_Run552*.root");
    ...
    cout << "Number of events with four layers hit: " << numFourLayers << endl;
    cout << "Number of events with three hits in a row: " << numThreeInRow << endl;
    cout << "Number of events with hits in two separate layers: " << numSeparate << endl;
    cout << "Number of events with hits in two adjacent layers: " << numAdjacent << endl;
