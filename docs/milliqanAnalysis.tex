...
\begin{figure}[ht!]
    \centering
    \subfloat[][Setup for $40\unit{cm}$\label{fig:setup40cmSep}]{\includegraphics[width=0.49\textwidth]{figures/setup40cmSep}}~
    \subfloat[][Setup for $2\unit{cm}$ with shielding\label{fig:setup2cmSepShield}]{\includegraphics[width=0.49\textwidth]{figures/setup2cmSepShield}}
    \caption{(a) The setup for the side-by-side rate tests with $40\unit{cm}$ spacing and (b) the setup for the side-by-side rate
    tests with $2\unit{cm}$ spacing and $12\unit{mm}$ of steel shielding.}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/rateVsSepSideBySide}
    \caption{The rate against separation for the side by side configuration
    with no shielding and with shielding between the 
    scintillator bars shown in black and red, respectively.}
\end{figure}

\begin{figure}[ht!]
    \centering
    \subfloat[][No shielding\label{fig:timeDiffSep40cm}]{\includegraphics[width=0.49\textwidth]{figures/timeDiffSep40cm}}~
    \subfloat[][Shielding\label{fig:timeDiffSep40cmShield}]{\includegraphics[width=0.49\textwidth]{figures/timeDiffSep40cmShield}}
    \caption{ The time difference between pulses in the two scintillator bars is shown for a separation 
    of $40\unit{cm}$ with shielding (a) and without shielding (b).}
\end{figure}

% \begin{figure}[ht!]
%     \centering
%     \includegraphics[width=0.6\textwidth]{figures/rateVsArea}
%     \caption{The rate against pulse area for two spacings is shown with no shielding and with shielding between 
%     the scintillator bars in black and red, respectively. The upper lines correspond to a separation
%     of 2\unit{cm} while the lower lines correspond to a separation of 10\unit{cm}.\label{fig:rateVsArea}}
% \end{figure}

The scintillator bars were placed end to end, as shown in Fig.~\ref{fig:setup20cmSepEToE}.
The rate was measured for two separations (20 and 70\unit{cm}) and with lead
shielding between the bars, as shown in Fig.~\ref{fig:setup20cmSepEToEShield}.

% \begin{figure}[ht!]
%     \centering
%     \subfloat[][Setup for $20\unit{cm}$\label{fig:setup20cmSepEToE}]{\includegraphics[width=0.49\textwidth]{figures/setup20cmSepEToE}}~
%     \subfloat[][Setup for $20\unit{cm}$ with shielding\label{fig:setup20cmSepEToEShield}]{\includegraphics[width=0.49\textwidth]{figures/setup20cmSepEToEShield}}
%     \caption{(a) The setup for the side-by-side rate tests with $40\unit{cm}$ spacing and (b) the setup for the side-by-side rate
%     tests with $2\unit{cm}$ spacing and $12\unit{mm}$ of steel shielding.}
% \end{figure}
%
% \begin{figure}[ht!]
%     \centering
%     \includegraphics[width=0.6\textwidth]{figures/rateVsSepEndToEnd}
%     \caption{The rate against separation for the end-to-end configuration
%     with no shielding and with shielding between the 
%     scintillator bars shown in black and red, respectively.}
% \end{figure}
%
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/LimitPlot_Demo_Split.pdf}
