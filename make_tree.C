...
float intraModuleCalibrations[] = {0.0, 0.0, -2.6875, -7.25, 0.5, 0.0, 2.0, 9.9375, 1.375, 0.0, -3.875, -3.6875, -1.625, 0.0, -24.1875, -5.0625};
float interModuleCalibrations[] = {0.0, 0.0, 0.0, 0.0, -6.0625, -6.0625, -6.0625, -6.0625, 8.375, 8.375, 8.375, 8.375, -6.0625, 0.0, 8.375, 0.0};
