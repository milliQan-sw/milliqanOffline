...
g++ -o $NAME make_tree_temporary_for_compile.C /home/milliqan/milliqanOffline/offlineProduction/src/OfflineFactory.cc /home/milliqan/MilliDAQ/src/ConfigurationReader.cc /home/milliqan/MilliDAQ/libMilliDAQ.so -lpython2.7 `root-config --cflags --glibs` -Wno-narrowing  # same as above but with correct local file path
if [ $? -eq 0 ]; then
